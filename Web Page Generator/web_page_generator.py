...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        self.lbl.grid(row=0, column=0, padx=(20,20), pady=(20,20))
        
        self.txt = Entry(self.master, text="", width=120)
        self.txt.grid(row=1, column=0, columnspan=2, padx=(20,20), pady=(0,0))
        ...
        self.btnCustom = Button(self.master, text="Submit Custom Text", width=30, height=2, command=self.customHeader)
